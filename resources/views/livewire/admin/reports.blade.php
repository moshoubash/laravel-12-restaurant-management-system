<div class="flex flex-col gap-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <h2 class="text-lg font-bold text-on-surface">Reports & Analytics</h2>
        <div class="flex flex-wrap items-center gap-3">
            ...
            <select wire:model.live="branchId" class="rounded border border-surface-container-high bg-surface-container-lowest px-3 py-1.5 text-sm text-on-surface focus:outline-none">
